...
const groups: NounGroups = {
  doctor: {
    '': lazy(meta, () => Promise.resolve(() => 0)),
    run: lazy(meta, () => Promise.resolve(() => 0)),
  },
}
